...
COOPstationsBEST <-  c("Ithaca, Freeville, Cortland") 
...
COOPstationsBACKUP <- c("Locke", "Groton","Marathon 1.0 NW")  
...
AWC_PERCENTAGE	<-	0.056	# [decimal %]

TIME_PEAK		<-	7		#  [hr] Time to peak ( 0.35*Tc+3.5 )
...
USGS_GAGE	<-  "04234000"		
	# USGS gage number (as text, include learing 0)
